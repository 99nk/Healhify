    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                category.setHint("Category: Patient");
            }
        ...
        updateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                user.put("category","Patient");
                currUserRef.updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                    @Override
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            Toast.makeText(EditPatientProfileActivity.this, "Details Saved", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(EditPatientProfileActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                        sendUserToDashboard();
                    }
                });
            ...
            private void sendUserToDashboard() {
                Intent chemist_intent=new Intent(EditPatientProfileActivity.this,PatientDashboardActivity.class);
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()){
                        case R.id.profile:
                            Intent profile_intent=new Intent(EditPatientProfileActivity.this,PatientProfileActivity.class);
                            profile_intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(profile_intent);
                            break;
                        case R.id.home:
                            Intent home_intent=new Intent(EditPatientProfileActivity.this,PatientDashboardActivity.class);
                            home_intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(home_intent);
                            break;
                        case R.id.settings:
                            Intent settings_intent=new Intent(EditPatientProfileActivity.this,SettingsActivity.class);
