    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent profile_intent=new Intent(ChemistProfileActivity.this,EditChemistProfileActivity.class);
        ...
        currUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                category.setText("Category: Chemist");
            }
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()){
                        case R.id.profile:
                            Intent profile_intent=new Intent(ChemistProfileActivity.this,ChemistProfileActivity.class);
                            profile_intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(profile_intent);
                            break;
                        case R.id.home:
                            Intent home_intent=new Intent(ChemistProfileActivity.this,ChemistDashboardActivity.class);
