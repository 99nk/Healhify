    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        currUserRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                category.setHint("Category: Dcotor");
            }
        ...
        updateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                user.put("category","Dcotor");
                currUserRef.updateChildren(user).addOnCompleteListener(new OnCompleteListener() {
                    @Override
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            Toast.makeText(EditDoctorProfileActivity.this, "Details Saved", Toast.LENGTH_SHORT).show();
                        }else{
                            Toast.makeText(EditDoctorProfileActivity.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                        sendUserToDashboard();
                    }
                });
            ...
            private void sendUserToDashboard() {
                Intent chemist_intent=new Intent(EditDoctorProfileActivity.this,DoctorDashboardActivity.class);
            ...
            new BottomNavigationView.OnNavigationItemSelectedListener() {
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    switch (item.getItemId()){
                        case R.id.profile:
                            Intent profile_intent=new Intent(EditDoctorProfileActivity.this,DoctorProfileActivity.class);
                            profile_intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(profile_intent);
                            break;
                        case R.id.home:
                            Intent home_intent=new Intent(EditDoctorProfileActivity.this,DoctorDashboardActivity.class);
                            home_intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_CLEAR_TASK);
                            startActivity(home_intent);
                            break;
                        case R.id.settings:
                            Intent settings_intent=new Intent(EditDoctorProfileActivity.this,SettingsActivity.class);
